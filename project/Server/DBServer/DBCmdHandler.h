...
public:
	...
	UINT32 OnCmdDBDelCharReq(UINT16 wCommandID, UINT64 u64ConnID, CBufferHelper *pBufferHelper);
	...
	UINT32 OnCmdDBLoadCharReq(UINT16 wCommandID, UINT64 u64ConnID, CBufferHelper *pBufferHelper);
