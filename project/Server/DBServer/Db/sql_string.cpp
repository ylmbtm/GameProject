    ...
    if ( this != &str_ )
    {
        if ( NULL != str_.m_str_ )
        {
            ...
            if ( m_off_ >= m_sz_ )
            {
                ...
                m_sz_  = _ALIGN( m_off_ + 1, _SIZE_ALIGN );
                m_str_ = (char*)malloc( m_sz_ );
            }
...
sql_string& sql_string::append( sql_string const &str_ )
{
    ...
    if ( this != &str_ )
    {
        if ( NULL != str_.m_str_ )
        {
            ...
            if ( _off >= m_sz_ )
            {
                _sz  = _ALIGN( _off + 1, _SIZE_ALIGN );
                _str = (char*)malloc( _sz );
...
int sql_string::compare( sql_string const &str_ ) const
{
    ...
    else if ( NULL != m_str_ && NULL != str_.m_str_ )
    {
        int     _ret = 0;
        size_t  _sz0 = m_off_;
...
{
    if ( NULL != m_str_ && NULL != str_ && sz_ > 0 )
    {
        int     _ret = 0;
        size_t  _sz0 = m_off_;
        size_t  _sz1 = sz_;
    ...
    else if ( NULL != m_str_ && sz_ > 0 )
    {
        return 1;
    }
    else if ( NULL != str_ && sz_ > 0 )
    {
        return -1;
    }
    else
